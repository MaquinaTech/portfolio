...
export default function Layout({ children }) {
  return (
    <div className="min-h-screen bg-gradient-to-br from-apple-50 via-white to-blue-50 font-sf">
      <Head>
        <title>Nicolás López de lerma López - Senior Specialist Developer</title>
        <meta name="description" content="Senior Specialist Developer with 6+ years leading technology teams. Expert in React Native, Laravel, AI systems, and scalable architecture." />
      ...
      <motion.main
        ...
        className="relative z-10 container mx-auto px-4 py-8 lg:px-8"
      >
        {children}
      </motion.main>
      ...
      <footer className="relative z-10 mt-20 glass border-t border-white/20">
        <div className="container mx-auto px-4 py-8 text-center">
          <motion.p 
            ...
            className="text-apple-600 font-medium"
          >
            © {new Date().getFullYear()} Nicolas Lopez de Lerma. Crafted with passion.
          </motion.p>
          <motion.div
          ...
          >
            <a href="#" className="text-apple-500 hover:text-blue-500 transition-colors duration-200">
